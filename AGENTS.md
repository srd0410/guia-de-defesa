# AGENTS.md — Guia de Defesa

Contexto permanente do projeto para qualquer sessão futura do Codex.
...
- `.Codex/skills/motor-de-conteudo/` — a skill que gera os artigos
...
A skill **motor-de-conteudo** (em `.Codex/skills/`) gera os posts `.mdx` no padrão
