...
<Faq items={[
  ...
  { q: "Os limites de acervo são iguais para caçador, atirador e colecionador?", a: "Não necessariamente — cada categoria de CAC tem seu próprio teto, definido pelo decreto vigente. Não assuma que o limite de um colega de outra categoria vale para você." },
