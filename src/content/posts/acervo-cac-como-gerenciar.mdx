...
description: "Como gerenciar o acervo de armas do CAC: aquisição com autorização da PF, transferência entre CACs, baixa de arma e registro em dia."
...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>Aquisição:</strong> autorização da PF antes da compra — nunca depois.</li>
    <li><strong>Transferência:</strong> processo formal entre as partes, concluído antes de entregar a arma.</li>
    <li><strong>Baixa:</strong> comunicação obrigatória em caso de venda, furto/roubo, inutilização ou entrega voluntária.</li>
    <li><strong>Furto ou roubo:</strong> comunicar imediatamente — arma não comunicada continua sob sua responsabilidade.</li>
    <li><strong>Erro mais comum:</strong> transferência informal "para regularizar depois" — deixa os dois lados irregulares.</li>
  </ul>
</Callout>
...
O terceiro erro é não acompanhar os limites de acervo antes de pedir autorização de aquisição. Quem solicita autorização sem saber se ainda tem capacidade de acervo leva uma negativa que poderia ter sido prevista. Checar os limites vigentes antes de iniciar o processo é o passo zero de qualquer aquisição — os três erros, no fundo, são falhas de antecipação, não de má-fé.

<Faq items={[
  { q: "Posso comprar sem esperar a autorização, se já sei que serei aprovado?", a: "Não. Não existe atalho: sem a autorização prévia da PF, a compra fica fora do sistema, independentemente de você preencher todos os requisitos." },
  { q: "E se eu só combinar a venda verbalmente e processar a transferência depois?", a: "Nesse meio-tempo, a arma segue formalmente no seu acervo — não no do comprador. Se algo acontecer com ela nesse intervalo, a responsabilidade ainda é sua." },
  { q: "Quanto tempo tenho para comunicar um furto?", a: "O ideal é comunicar no mesmo dia. Não existe prazo de tolerância definido em lei — quanto mais rápido, menor a janela de responsabilidade sobre uma arma que já não está com você." },
  { q: "O que é a baixa de arma?", a: "É o processo que retira uma arma do seu acervo de forma definitiva — por furto comunicado, transferência, inutilização ou entrega voluntária. Cada saída tem um processo correspondente que precisa ser formalizado junto à PF." },
  { q: "Os limites de acervo são iguais para caçador, atirador e colecionador?", a: "Não necessariamente — cada categoria de CAC tem seu próprio teto, definido pelo decreto vigente. Não assuma que o limite de um colega de outra categoria vale para você. O passo a passo específico da categoria colecionador está em <a href='/colecionamento-de-armas-como-começar/'>colecionamento de armas: como começar</a>." },
  { q: "Quem autoriza aquisição e transferência de arma de CAC hoje?", a: "A Polícia Federal, desde 1º de julho de 2025. Qualquer orientação que ainda direcione ao Exército está desatualizada — confirme o procedimento atual nos canais oficiais da PF." },
]} />
