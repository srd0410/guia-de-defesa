...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>Três categorias:</strong> atirador desportivo (habitualidade), colecionador (acervo histórico/cultural) e caçador (licença específica e restrita).</li>
    <li><strong>O que autoriza:</strong> ter e transportar arma de forma regulada (guia de tráfego) até a atividade — não é porte.</li>
    <li><strong>Como entrar:</strong> definir categoria → estudar a norma vigente → filiar-se a clube/entidade → exames → documentação → registro na PF.</li>
    <li><strong>Como se manter:</strong> comprovar habitualidade, renovar laudos e documentos, guardar as armas em cofre.</li>
    <li><strong>Quem controla hoje:</strong> Polícia Federal, desde 1º de julho de 2025 — não mais o Exército.</li>
  </ul>
</Callout>
...
O transporte regulado da arma entre casa e o local de prática é feito com **guia de tráfego**, emitida pela Polícia Federal desde julho de 2025 — tema detalhado no guia de [guia de tráfego](/guia-de-trafego/). O CAC autoriza ter e usar a arma na atividade; não autoriza andar armado fora desse contexto sem as autorizações adicionais correspondentes.
...
Há ainda as obrigações de **guarda e acervo**: a arma precisa ser guardada de forma adequada (cofre, como descrito no guia de [cofre para arma](/cofre-para-arma/)), e qualquer aquisição, transferência ou baixa de armamento precisa ser registrada e processada corretamente. Ser CAC é um compromisso contínuo — quem entra com essa clareza prospera no sistema; quem trata como formalidade acumula problemas.
...
As **obrigações** incluem: comprovar a habitualidade (atirador), manter os laudos e documentos válidos, guardar as armas de forma adequada, registrar aquisições e baixas, e cumprir os procedimentos de renovação nos prazos. O não cumprimento de qualquer dessas obrigações pode levar à irregularidade do registro — que, por sua vez, pode fazer as armas do acervo virarem posse ou porte irregular. No fundo, o CAC funciona como um contrato: o Estado autoriza o acervo e a atividade; o CAC cumpre as regras que sustentam essa autorização. Cumprir as regras não é custo — é o que mantém o direito.
...
<Faq items={[
  ...
  { q: "O que acontece se eu parar de praticar tiro sendo atirador?", a: "Você arrisca perder a condição de atirador na renovação seguinte — não existe um prazo de tolerância único e público, o clube e a PF é que avaliam a regularidade da frequência." },
...
Salve este guia como o mapa do universo CAC e aprofunde nos temas específicos: [como tirar o CAC](/como-tirar-cac/), [como se manter CAC](/como-se-manter-cac/), o [guia completo da renovação de CRAF](/renovacao-de-craf-guia-completo/) e o [calendário de renovação de CRAF 2026](/renovacao-craf-2026/), [quais armas o CAC pode ter](/quais-armas-cac-pode-ter/), [guia de tráfego](/guia-de-trafego/), [como escolher um clube de tiro](/clubes-de-tiro-no-brasil/), o papel das [federações de tiro esportivo](/federacoes-de-tiro-esportivo/), [o que fazer numa abordagem policial sendo CAC](/abordagem-policial-sendo-cac/), o novo [Portal PF](/portal-pf-novo-sistema-cac/) que passa a processar esses pedidos a partir de julho de 2026 e, para o quadro legal de base, a [lei de armas no Brasil](/lei-de-armas-no-brasil/). Para a jornada completa do atirador — do clube à primeira arma em casa —, veja [como tirar o CR de atirador e comprar a primeira arma](/como-tirar-cr-de-atirador-e-comprar-a-primeira-arma/). Explore a categoria de [CAC e Tiro Desportivo](/categoria/cac-tiro-desportivo/).
