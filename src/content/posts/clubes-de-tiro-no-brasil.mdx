...
description: "Como escolher um clube de tiro no Brasil: o que analisar, clube x federação, como ele sustenta a habitualidade do CAC e por onde começar."
...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>Por que importa:</strong> é o clube que registra a frequência que comprova a habitualidade do CAC.</li>
    <li><strong>O que analisar:</strong> segurança, estrutura/modalidades, instrução, organização administrativa e localização — visite antes de decidir.</li>
    <li><strong>Clube x federação:</strong> você se filia ao clube, que é filiado à federação — a federação valida a condição esportiva perante a PF.</li>
    <li><strong>Registro de visitas:</strong> confirme que cada sessão está sendo computada — não presuma que é automático.</li>
    <li><strong>Competir:</strong> não é obrigatório para manter o CAC, mas reforça a comprovação de atividade.</li>
  </ul>
</Callout>
...
<Faq items={[
  ...
  { q: "Posso trocar de clube sem perder a habitualidade já acumulada?", a: "O histórico de frequência no clube anterior costuma ser preservado como registro passado, mas confirme com o novo clube e com a PF como a transição é tratada — não é um processo padronizado e documentado de forma uniforme." },
  { q: "O que fazer se eu suspeitar que uma visita não foi registrada?", a: "Peça a confirmação ao clube na hora, não semanas depois — quanto mais cedo o erro é corrigido, menor o risco de uma lacuna aparecer só na hora da renovação." },
...
Salve este guia e visite mais de um clube antes de decidir. Para o quadro completo do CAC, o [guia completo do CAC](/cac-guia-completo/); para o desenvolvimento técnico, [como começar no tiro esportivo](/como-comecar-tiro-esportivo/) e os [fundamentos do tiro](/fundamentos-do-tiro/); para escolher a modalidade certa antes de montar acervo, o [comparativo de modalidades de tiro esportivo](/modalidades-de-tiro-esportivo/); e para as obrigações de manutenção do registro, [como se manter CAC](/como-se-manter-cac/).
