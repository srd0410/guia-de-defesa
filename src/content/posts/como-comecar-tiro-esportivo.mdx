...
<Faq items={[
  { q: "Preciso ser CAC para começar a atirar?", a: "Não. Você pode começar como praticante em um clube de tiro, usando armas do clube e instrução local, sem nenhum registro. O CAC só é necessário quando você decide ter arma própria para o esporte." },
  { q: "Quem autoriza a compra de arma para CAC hoje?", a: "A autorização de compra é processada pela Polícia Federal — não mais pelo Exército, como era antes. Como as regras mudam, confirme o procedimento vigente diretamente nos canais oficiais da Polícia Federal." },
  ...
  { q: "Qual modalidade é melhor para iniciantes?", a: "Não há uma única resposta — depende do que o seu clube oferece com bom suporte a novatos. Modalidades de regras simples, como as focadas em velocidade sobre alvos de aço, costumam ser boas portas de entrada. O essencial é dominar os fundamentos, que servem para todas." },
  { q: "Qual equipamento é obrigatório no primeiro treino?", a: "Proteção auditiva (protetor auricular) e proteção visual (óculos balísticos) são inegociáveis. Arma e munição costumam vir do clube na fase inicial. Roupas adequadas e calçado fechado completam o necessário para começar." },
