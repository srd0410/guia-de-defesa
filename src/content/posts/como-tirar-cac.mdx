...
description: "Como tirar o CAC sem se perder na burocracia: as três categorias, os requisitos, as etapas na PF e os erros que travam quem é iniciante."
category: "cac-tiro-desportivo"
pubDate: 2026-06-14
updatedDate: 2026-09-22
tags: ["cac", "caçador atirador colecionador", "polícia federal", "legislação"]
draft: false
---
...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>Categorias:</strong> caçador, atirador ou colecionador — escolha conforme a atividade real.</li>
    <li><strong>Quem controla:</strong> Polícia Federal, não mais o Exército, desde 1º de julho de 2025.</li>
    <li><strong>Requisitos:</strong> idade mínima, ocupação lícita, residência fixa, antecedentes limpos, aptidão psicológica e técnica.</li>
    <li><strong>Ordem certa:</strong> categoria → exames de aptidão → documentação → protocolo na PF.</li>
    <li><strong>Erro mais comum:</strong> seguir tutorial desatualizado que ainda manda "ir ao Exército".</li>
  </ul>
</Callout>
...
A partir de julho de 2026, esse protocolo passa a ser feito pelo [Portal PF](/portal-pf-novo-sistema-cac/), o sistema que substitui o SINARM-CAC e o Regula-CAC. Vale conferir esse guia antes de iniciar o seu processo, para saber qual canal está ativo no momento do seu pedido.
...
Antes de gastar com exames, decida a categoria e leia a regulamentação **vigente**. Como as normas mudam, partir de informação desatualizada é o erro que mais custa tempo e dinheiro. Comece pela informação correta e atual, não pela compra.
...
Junte os documentos pessoais, comprovantes e as certidões negativas exigidas. A organização aqui é o que separa um processo fluido de um processo que volta para correção várias vezes: documentação completa e dentro da validade já resolve metade do pedido.
...
<Faq items={[
  { q: "Ter antecedente criminal antigo, já prescrito, impede o CAC?", a: "Depende do que consta nas certidões negativas exigidas no momento do pedido — não há uma resposta genérica que sirva para todo histórico. Esse é um ponto para verificar com a Polícia Federal ou um advogado antes de investir em exames." },
...
Salve este artigo como o seu mapa do processo e use-o junto com a regulamentação oficial atual, que é onde estão os números que mudam. E se você conhece alguém perdido na burocracia do CAC — quase todo iniciante está —, mande este texto para organizar a cabeça dele antes do primeiro gasto. Para entender o que você poderá adquirir em cada categoria, veja também [quais armas um CAC pode ter](/quais-armas-cac-pode-ter), e para o quadro legal da defesa, o guia de [legítima defesa no Brasil](/legitima-defesa-no-brasil). Para a categoria de caçador especificamente, veja o que é permitido em [caça no Brasil](/caca-no-brasil-o-que-e-permitido/). Para o mapa completo do sistema, a [lei de armas no Brasil](/lei-de-armas-no-brasil/).
