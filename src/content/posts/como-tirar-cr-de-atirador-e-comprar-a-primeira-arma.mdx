...
<Faq items={[
  ...
  { q: "Posso comprar qualquer arma assim que o CR é aprovado?", a: "Não. O CR aprovado permite solicitar a autorização de compra para uma arma específica, dentro dos limites de quantidade e classificação (uso permitido x restrito) vigentes para a categoria atirador. Confirme sempre esses limites antes de escolher o modelo." },
  { q: "Como levo a arma da loja até minha casa depois da compra?", a: "O deslocamento precisa seguir as regras de transporte regulado: arma desmuniciada, acondicionada sem estar pronta para uso, e acompanhada da documentação da compra. Dependendo da regra vigente, esse trajeto pode envolver a guia de tráfego — confirme com a loja e a norma atual no momento da sua compra." },
  { q: "Preciso comprovar habitualidade antes de tirar o CR, ou só depois?", a: "A prática regular no clube deve começar antes ou durante o processo, não depois. A habitualidade real e contínua é o que sustenta a categoria de atirador desde a aprovação do CR e nas renovações futuras — não é algo para 'resolver depois' que o certificado sai." },
  { q: "O que fazer com a arma assim que ela chega em casa?", a: "Guardá-la imediatamente em local seguro, como um cofre fixado e adequado, e passar a tratá-la como parte do seu acervo formal — sujeita às mesmas obrigações de manutenção e comunicação que qualquer outra arma do seu registro CAC." },
]} />
