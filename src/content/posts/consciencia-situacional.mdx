...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>O que é:</strong> perceber sinais de risco antes que virem ameaça, sem viver em alerta constante.</li>
    <li><strong>Código de cores:</strong> branco (desatenção) a vermelho (ação) — o padrão ideal na rua é amarelo.</li>
    <li><strong>Sinal de risco real:</strong> convergência de pelo menos três sinais diferentes, não um isolado.</li>
    <li><strong>Ciclo OODA:</strong> quem já ensaiou mentalmente o cenário decide e age mais rápido.</li>
    <li><strong>Como treinar:</strong> hábito diário simples — notar pessoas, saídas e anomalias no ambiente.</li>
  </ul>
</Callout>
...
Alguns dados recentes ajudam a dimensionar onde o risco realmente se concentra — e reforçam por que o celular é justamente o vetor de distração mais perigoso. O 19º Anuário Brasileiro de Segurança Pública (Fórum Brasileiro de Segurança Pública, 2025) mostra que 79,6% dos roubos de aparelho celular em 2024 ocorreram em via pública, com concentração em dois picos de horário: início da manhã (6h–8h) e início da noite (19h–20h) — exatamente os trajetos de ida e volta do trabalho, quando a atenção costuma estar mais baixa por cansaço ou pressa. Saber isso não é motivo para pânico; é um dado prático para calibrar em que momentos vale reforçar a atenção, principalmente com o celular guardado. Perceber a aproximação enquanto ainda há distância é o que preserva a opção de simplesmente não estar lá — o que fazer quando essa janela já se fechou está em [o que fazer em um assalto](/o-que-fazer-em-um-assalto/).
...
- No carro, eleve a atenção na chegada e na saída de casa: a entrada de garagem, com o motorista parado e concentrado no portão, é o ponto mais explorado no [sequestro relâmpago](/sequestro-relampago-como-agir/).
...
<Faq items={[
  ...
  { q: "É possível pular direto do branco para o vermelho, sem passar pelo amarelo e pelo laranja?", a: "Sim, e é exatamente isso que torna uma emboscada tão perigosa — quem estava em branco não teve o aviso intermediário do laranja para preparar o corpo. É outro motivo prático para manter o amarelo como padrão, não só o vermelho como reação de pânico." },
  { q: "O ciclo OODA serve só para confronto físico, ou se aplica a outras decisões?", a: "Se aplica a qualquer decisão sob pressão de tempo, não só defesa pessoal — é usado em pilotagem, negócios e esportes de alta performance. Aqui, o recorte é a resposta a ameaça." },
  { q: "Dois sinais que se repetem contam como convergência, ou precisa ser sempre três tipos diferentes?", a: "O número em si importa menos que a convergência: sinais de naturezas diferentes (olhar + aproximação + reposicionamento corporal) pesam mais que a repetição do mesmo sinal isolado." },
  { q: "O risco de roubo de celular é uniforme ao longo do dia, ou existe hora mais perigosa?", a: "Não é uniforme — concentra em dois picos (6h–8h e 19h–20h), os horários de deslocamento casa-trabalho, segundo o 19º Anuário Brasileiro de Segurança Pública (2025)." },
  { q: "Quanto tempo leva para consciência situacional virar hábito automático, sem esforço consciente?", a: "Não há um número validado cientificamente para esse hábito específico — varia por pessoa e frequência de prática. O sinal de que virou automático é notar o ambiente sem precisar se lembrar de fazer isso." },
]} />
...
Aprofunde esse fundamento com o artigo sobre [mindset de defesa pessoal](/mindset-de-defesa/), que cobre a mentalidade de quem consegue se defender, e com [ética e responsabilidade no uso da força](/etica-responsabilidade-uso-da-forca/), que trata do limite entre perceber a ameaça a tempo e saber até onde a resposta deve ir.
