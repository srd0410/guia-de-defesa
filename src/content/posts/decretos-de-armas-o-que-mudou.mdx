...
<Faq items={[
  ...
  { q: "Qual a diferença entre a lei e o decreto de armas?", a: "A lei (Estatuto do Desarmamento, 10.826/2003) é aprovada pelo Congresso e define a estrutura do sistema — muda devagar. O decreto é editado pela Presidência para regulamentar a lei e preencher os detalhes — e pode ser alterado ou revogado por outro decreto a qualquer tempo. Quase toda \"mudança nas regras de armas\" é mudança de decreto." },
  { q: "O que mudou nos decretos de armas recentemente?", a: "Em traços gerais: decretos de 2019 ampliaram o acesso; os de 2023 (como o 11.615 e o 11.366) restringiram e iniciaram a transferência do controle de CAC para a Polícia Federal; o de 2024 (12.345) ajustou pontos, como devolver o .22 LR semiautomático ao uso permitido. O STF validou os decretos de 2023. Confirme o status atual na fonte oficial." },
  ...
  { q: "Quem controla as armas de CAC depois das mudanças?", a: "A Polícia Federal. Os decretos de 2023 iniciaram a transferência do Exército para a PF, e desde 1º de julho de 2025 o registro, a autorização de compra, as guias de tráfego e a fiscalização das atividades de CAC são da Polícia Federal. Essa é uma das mudanças mais relevantes e mais ignoradas por conteúdo desatualizado." },
  { q: "Como saber qual regra está valendo agora?", a: "Confirmando na fonte oficial antes de agir: a Polícia Federal para procedimentos e controle de CAC, e o portal oficial da legislação federal para o texto atual das leis e decretos. Use guias para entender a estrutura, mas trate todo número específico como algo a verificar na norma vigente." },
]} />
