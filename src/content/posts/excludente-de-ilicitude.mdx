...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>O que é:</strong> mecanismo que faz um ato em princípio criminoso deixar de ser contrário ao direito.</li>
    <li><strong>Quatro hipóteses:</strong> legítima defesa, estado de necessidade, estrito cumprimento do dever legal e exercício regular de direito.</li>
    <li><strong>Legítima defesa x estado de necessidade:</strong> uma repele agressor injusto; a outra sacrifica um bem diante de perigo, sem agressor.</li>
    <li><strong>Não é perdão:</strong> quando há excludente, não houve crime algum desde o início.</li>
    <li><strong>Base da legítima defesa:</strong> é a excludente que dá fundamento jurídico ao direito de se defender.</li>
  </ul>
</Callout>
