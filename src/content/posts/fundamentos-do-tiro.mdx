...
Na prática, depois de cada tiro mantenha a mira no alvo por um instante, observe onde o ponto ou a massa estão e confirme o impacto antes de decidir o próximo passo. Esse meio-segundo de confirmação parece pequeno, mas é o que separa uma sequência de tiros controlada de uma rajada no susto. Na prática, velocidade real não nasce de apressar o disparo — nasce de encurtar esse ciclo de confirmação com repetição, mantendo o controle enquanto o tempo cai.
