...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>A base:</strong> Estatuto do Desarmamento (Lei 10.826/2003) — estável, muda só por novo processo legislativo.</li>
    <li><strong>O que oscila:</strong> números, prazos e detalhes definidos por decreto, mudam com frequência conforme o governo.</li>
    <li><strong>Estrutura fixa:</strong> registro, distinção entre posse e porte, uso permitido x restrito, tipificação dos crimes.</li>
    <li><strong>Quem controla hoje:</strong> fiscalização e registros migraram do Exército para a Polícia Federal.</li>
    <li><strong>Como não se perder:</strong> confirmar sempre a norma vigente nas fontes oficiais, não em informação desatualizada.</li>
  </ul>
</Callout>
...
Vale registrar, para precisão, que a transferência foi feita por decreto e gerou debate jurídico (sobre a compatibilidade com a Lei 10.826/2003), mas o STF validou os decretos de 2023, e operacionalmente é a Polícia Federal que conduz o registro e a fiscalização desde então. Para o cidadão comum, o registro de posse para defesa também tramita pelos canais oficiais do sistema de controle. A pergunta "para onde vai o meu processo?" tem hoje uma resposta única no universo CAC — a Polícia Federal —, e essa é uma das informações que mais separa o conteúdo atualizado do obsoleto.
...
<Faq items={[
  { q: "Qual é a lei que rege as armas no Brasil?", a: "O Estatuto do Desarmamento, Lei nº 10.826/2003. Ela estrutura o sistema (registro, posse, porte) e tipifica os crimes; os detalhes práticos — quantidades, calibres, procedimentos — ficam em decretos, que mudam com frequência." },
  { q: "O Estatuto do Desarmamento foi revogado ou continua valendo?", a: "Continua valendo, e o STF já validou a constitucionalidade dos decretos de 2023 que reorganizaram o controle. O que muda são os decretos que o regulamentam, nunca a lei-base em si." },
  { q: "Levar a arma carregada até o clube de tiro conta como transporte regular?", a: "Não. O transporte exige a arma desmuniciada, guardada de forma adequada e com documentação que justifique o trajeto. Levá-la municiada e ao alcance no carro descaracteriza o transporte e pode configurar porte ilegal, mesmo que o destino seja o próprio estande." },
  { q: "O rifle .22 LR semiautomático é de uso permitido ou restrito hoje?", a: "Uso permitido, desde o Decreto 12.345/2024. Mas esse é exatamente o tipo de classificação técnica que já mudou mais de uma vez em poucos anos por decreto — confirme sempre a norma vigente antes de decidir com base nela." },
  { q: "Ter porte de arma é pré-requisito para alegar legítima defesa?", a: "Não. Legítima defesa é sobre o uso da força diante de uma agressão injusta, e se aplica independentemente de porte, posse ou mesmo de a pessoa estar armada. Ter arma legalmente não diz nada sobre quando e como usá-la — isso é regido pelas regras de uso da força." },
  { q: "Quem controla as armas de CAC hoje, Exército ou Polícia Federal?", a: "A Polícia Federal, desde 1º de julho de 2025. Conteúdo que ainda manda \"protocolar no Exército\" está desatualizado." },
  { q: "Onde confiro a regra atual antes de agir?", a: "Nas fontes oficiais: a Polícia Federal, para procedimentos, e o portal da legislação federal (Planalto), para o texto de leis e decretos. Guias como este explicam a estrutura; os números e prazos vigentes precisam ser confirmados ali." },
]} />
