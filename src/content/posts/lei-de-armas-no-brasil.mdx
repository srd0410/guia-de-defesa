...
Este guia é o ponto de partida do cluster de legislação e direito do Guia de Defesa. A partir dele, aprofunde nos temas específicos: [posse x porte de arma](/posse-x-porte-de-arma/), [como tirar o CAC](/como-tirar-cac/), [quais armas o CAC pode ter](/quais-armas-cac-pode-ter/), [legítima defesa no Brasil](/legitima-defesa-no-brasil/), [excludente de ilicitude](/excludente-de-ilicitude/) e [o que fazer depois de uma legítima defesa](/o-que-fazer-depois-legitima-defesa/). Explore também a categoria de [legislação e direito](/categoria/legislacao/).
