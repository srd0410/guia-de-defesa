...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    ...
    <li><strong>Materiais:</strong> kydex pela consistência, couro pelo conforto, híbrido pelo meio-termo.</li>
...
O **híbrido** tune combina uma concha de kydex (que segura a arma e cobre o gatilho com rigidez) sobre uma base de couro ou de material acolchoado (que fica contra o corpo, dando conforto). A proposta é unir a segurança e a retenção do kydex ao conforto do couro. Funciona bem para muita gente, especialmente no porte interno por longas horas; a limitação é que tende a ser mais volumoso, e a qualidade varia bastante entre fabricantes. Dito de outro jeito: kydex pela segurança e consistência, couro pelo conforto tradicional, híbrido buscando o meio-termo — e em todos, a construção importa mais que o material em si.
