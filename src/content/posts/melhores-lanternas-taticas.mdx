...
<ProductCard
  store="mercadolivre"
  name="Apfer T9 (acionamento lateral) — 2ª opção, entrega rápida"
  url="https://meli.la/27Y8mUf"
  take="Alternativa para quem não quer esperar o AliExpress e prefere entrega rápida pelo Mercado Livre. Diferente da Sofirn SP31, não tenho uso pessoal desta lanterna — a indicação é baseada em pesquisa e depoimentos de outros usuários, não em experiência própria."
/>
