...
<Faq items={[
  ...
  { q: "Mais lúmens significa lanterna melhor?", a: "Não. Lúmens medem o fluxo total de luz, não o alcance nem a qualidade do facho. Uma lanterna de menos lúmens com facho concentrado pode enxergar mais longe que uma potente de facho largo. Autonomia, construção e interface importam tanto quanto a potência." },
  { q: "O que é step-down numa lanterna?", a: "É a redução automática de brilho que muitas lanternas fazem após alguns minutos no modo máximo, para evitar superaquecimento. Por isso a potência de pico raramente se sustenta — uma lanterna de potência moderada e constante costuma ser mais útil que uma de pico alto e efêmero." },
