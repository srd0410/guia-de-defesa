...
<ProductCard
  store="outro"
  name="Lanterna tática recarregável (modelo de bolso)"
  url="SEU-LINK-DE-AFILIADO"
  price=""
  take="Para a maioria, a porta de entrada certa é uma lanterna de bolso com 300–800 lúmens, recarga USB e acionamento traseiro com uma mão. Antes de fechar, confira nas avaliações a autonomia real e se a potência se sustenta (sem step-down agressivo). Carregar todo dia vale mais que cravar o recorde de lúmens."
/>
