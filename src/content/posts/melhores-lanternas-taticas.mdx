...
<ProductCard
  store="aliexpress"
  name="Sofirn SP31 (acionamento traseiro) — 1ª escolha"
  url="SEU-LINK-DE-AFILIADO"
  take="Minha indicação prioritária pelo conjunto e pela durabilidade comprovada no uso: bateria 18650 recarregável, acionamento traseiro de uma mão, modo baixo para EDC e modo forte para uso tático e defesa. Liga direto no modo principal, sem passar por estroboscópio. Confira a versão e a saída de lúmens no anúncio antes de fechar."
/>

{/* TEMPORÁRIO: a Apfer T9 (Mercado Livre) é alternativa rápida enquanto os links da Sofirn SP31 (AliExpress + Shopee) não estão cadastrados. Remover este card quando os links da Sofirn entrarem. */}
<ProductCard
  store="mercadolivre"
  name="Apfer T9 (acionamento lateral) — alternativa EDC"
  url="https://meli.la/27Y8mUf"
  take="Opção alternativa para quem quer resolver rápido com pronta-entrega no Brasil. Tem acionamento lateral (em vez do traseiro), o que muda a pegada — alguns preferem, outros não. Cumpre bem o papel de lanterna de EDC do dia a dia; se puder, prefira a primeira escolha pela qualidade de construção."
/>
