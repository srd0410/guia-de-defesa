...
affiliate: true
ads: true
sponsorAffiliateLabel: "Ver Holosun EPS-RD2 no Mercado Livre"
sponsorAffiliateHref: "https://meli.la/2MeQWve"
---
...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>Prioridade um:</strong> durabilidade ao recuo — uma ótica que descalibra ou apaga não compensa desconto.</li>
    <li><strong>Bateria:</strong> priorize autonomia longa e <em>shake-awake</em>, que liga sozinha ao menor movimento.</li>
    <li><strong>Footprint:</strong> o padrão de encaixe (RMR, RMSc, Shield) precisa casar com a sua pistola.</li>
    <li><strong>Astigmatismo:</strong> quem tem esse desvio pode enxergar o ponto espremido — teste antes de comprar.</li>
    <li><strong>Co-witness:</strong> manter as miras de ferro visíveis dentro da janela é um plano B opcional, não obrigatório.</li>
  </ul>
</Callout>
