...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>Primeiro passo:</strong> cesse a ação assim que a ameaça for neutralizada.</li>
    <li><strong>Chame você mesmo:</strong> acione a polícia e o socorro por iniciativa própria.</li>
    <li><strong>Não toque em nada:</strong> preserve a cena como prova material da sua versão.</li>
    <li><strong>Direito ao silêncio:</strong> identifique-se, informe o essencial e aguarde o advogado para o relato completo.</li>
    <li><strong>Evite:</strong> fugir, postar nas redes sociais ou dar entrevistas sobre o ocorrido.</li>
  </ul>
</Callout>
...
<Faq items={[
  ...
  { q: "Posso entrar em contato com a família ou amigos da pessoa envolvida depois do ocorrido?", a: "Não é recomendado. Qualquer contato com a outra parte ou com familiares dela pode ser mal interpretado — como intimidação, tentativa de acordo ou pressão sobre testemunhas — mesmo que a intenção seja boa. Deixe qualquer comunicação necessária a cargo do seu advogado, que sabe como e quando ela deve (ou não) acontecer." },
  { q: "Testemunhas no local ajudam a confirmar que foi legítima defesa?", a: "Sim, podem ajudar bastante. Se havia pessoas no local, anote (ou peça para alguém anotar) nome e contato delas assim que possível — memórias e disponibilidade se perdem rápido com o tempo. Isso não substitui nenhum dos passos do protocolo, mas soma a favor da sua versão dos fatos quando o caso for analisado." },
  ...
  { q: "Devo buscar atendimento médico mesmo se os ferimentos parecerem leves?", a: "Sim, sempre que houver qualquer ferimento, por menor que pareça. Além do cuidado com a sua saúde, o atendimento médico gera um registro formal e datado das suas lesões, que pode ser relevante para comprovar que houve agressão real contra você. Não dispense esse passo achando que \"não é nada\"." },
