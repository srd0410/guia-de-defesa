...
Resista ao impulso de "organizar" a cena — mover a arma do agressor, recolher objetos, ajeitar qualquer coisa. O local, do jeito que ficou, é a prova material que pode confirmar a sua versão dos fatos; alterá-lo, ainda que por nervosismo, pode ser interpretado como tentativa de manipular a evidência. E daí? Daí que, por mais difícil que seja ficar parado, preservar a cena trabalha a seu favor — ela conta a história que você vai precisar que seja contada.
