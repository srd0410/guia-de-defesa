...
A **comunicação** amarra tudo. O plano define quem chama a polícia (e que essa pessoa o faça assim que estiver segura, não antes), uma palavra-código que aciona o plano sem alarde ("o plano agora"), e como a família se comunica se separada (mensagem combinada, ligação ao ponto de encontro). Manter um celular sempre carregado é parte da infraestrutura do plano. Rotas dizem como chegar, o ponto de encontro confere quem chegou, e a comunicação aciona o plano e chama o socorro — três peças que evitam o pior erro do pânico, que é agir desencontrado.
