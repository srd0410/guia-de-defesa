...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>Cômodo seguro:</strong> ponto de convergência trancado para onde a família vai em vez de enfrentar o intruso.</li>
    <li><strong>Rotas:</strong> caminhos definidos de antemão até o refúgio, mapeados para não decidir no susto.</li>
    <li><strong>Ponto de encontro:</strong> local combinado fora de casa para conferir se todos saíram em segurança.</li>
    <li><strong>Comunicação:</strong> quem chama a polícia e a palavra-código que aciona o plano.</li>
    <li><strong>Ensaio:</strong> um plano só funciona se for treinado com a família, com calma, periodicamente.</li>
  </ul>
</Callout>
...
A **comunicação** amarra tudo. O plano define quem chama a polícia (e que essa pessoa o faça assim que estiver segura, não antes), uma palavra-código que aciona o plano sem alarde ("o plano agora"), e como a família se comunica se separada (mensagem combinada, ligação ao ponto de encontro). Manter um celular sempre carregado é parte da infraestrutura do plano; para eventos que ultrapassam o imóvel, o [plano de comunicação familiar em emergências](/plano-de-comunicacao-familiar-em-emergencias/) detalha contato central, mensagens curtas e alternativas sem internet. Rotas dizem como chegar, o ponto de encontro confere quem chegou, e a comunicação aciona o plano e chama o socorro — três peças que evitam o pior erro do pânico, que é agir desencontrado.
...
<Faq items={[
  ...
  { q: "Preciso ter arma de fogo em casa para montar um plano de casa segura?", a: "Não. O plano é sobre coordenação — cômodo seguro, rotas, ponto de encontro e comunicação —, não sobre um item específico de defesa. A arma de defesa, quando existe, entra como um recurso dentro do cômodo seguro, mas famílias sem arma se beneficiam do mesmo plano exatamente da mesma forma." },
  { q: "O plano muda para quem mora em apartamento em vez de casa?", a: "A lógica é a mesma, mas os detalhes mudam: o cômodo seguro tende a ficar mais perto (menos deslocamento), e o ponto de encontro externo precisa considerar elevador x escada numa emergência e um local de reunião fora do prédio, não só fora da unidade." },
  { q: "E se houver uma visita ou uma babá em casa na hora da emergência?", a: "Vale incluir qualquer pessoa que fique com frequência em casa numa versão simplificada do plano: para onde ir e o que não fazer (não sair procurando o barulho). Não é preciso ensaiar com todo visitante, mas quem cuida das crianças regularmente deveria saber pelo menos o cômodo seguro e o ponto de encontro." },
  { q: "O que fazer se o alarme disparar e for falso positivo (um gato, uma entrega)?", a: "Trate com a mesma calma do ensaio: converja ao cômodo seguro primeiro, confirme a causa depois, com a família já reunida e segura. Descartar o alarme como falso antes de agrupar a família é o hábito que, um dia, atrasa a resposta a um alarme real." },
  { q: "Devo sair procurando o intruso pela casa?", a: "Não. Percorrer a casa atrás do invasor é a tarefa mais perigosa que existe e entrega todas as vantagens a ele. O plano prioriza convergir ao cômodo seguro, trancar, chamar a polícia e esperar. Só se usa a força se a ameaça vier até a porta do refúgio." },
