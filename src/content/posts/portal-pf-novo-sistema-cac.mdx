...
O ponto central é a automação. Segundo a própria PF, o Portal PF foi desenhado para processar de forma automatizada cerca de **88% das demandas**, com consulta automática de antecedentes criminais federais e integração via API com outras bases de dados. Em resumo: o Portal PF existe para destravar o gargalo de processos que os sistemas anteriores não davam conta de absorver, usando automação e inteligência artificial na análise documental.
...
<Faq items={[
  ...
  { q: "Quando o Portal PF entra em funcionamento?", a: "A entrada em produção está prevista para 1º de julho de 2026, com início efetivo da operação em 12 de julho de 2026. A ampliação para todos os serviços de CAC segue até o segundo semestre de 2026." },
  { q: "O Portal PF substitui o SINARM-CAC?", a: "Sim, na proposta apresentada pela PF, o Portal PF substitui tanto o SINARM-CAC quanto o Regula-CAC no controle de CACs, com um período de transição esperado para processos já em andamento." },
  { q: "Preciso me cadastrar de novo no Portal PF?", a: "O acesso segue via conta Gov.br, o mesmo modelo já usado no SINARM-CAC. Ainda assim, confirme nos canais oficiais da PF se há algum passo de migração de cadastro necessário no seu caso." },
  ...
  { q: "A automação do Portal PF garante aprovação mais rápida?", a: "Processos simples e bem-instruídos tendem a ser decididos mais rápido, já que cerca de 88% das demandas devem ser processadas de forma automatizada. Documentação incompleta ou inconsistente, porém, cai para análise manual e pode levar mais tempo." },
  ...
  { q: "O que acontece com um processo aberto no SINARM-CAC antes da troca?", a: "A expectativa é de um período de convivência entre sistemas para processos em andamento. O caminho mais seguro é consultar a PF diretamente sobre a migração do seu processo específico, em vez de presumir a continuidade automática." },
  { q: "O Portal PF já tem todos os serviços disponíveis no lançamento?", a: "Não necessariamente. O lançamento é por entregas incrementais, e a ampliação para os demais serviços de CAC está prevista para o segundo semestre de 2026. Verifique se o serviço que você precisa já está disponível." },
  { q: "Onde acompanho informações oficiais sobre o Portal PF?", a: "Nos canais oficiais da Polícia Federal (gov.br/pf). Como o sistema está em fase de lançamento, evite se basear em tutoriais de terceiros desatualizados e confirme sempre a informação na fonte oficial." },
]} />
