...
description: "Protetor auricular para tiro: atenuação (NRR), proteção passiva x eletrônica, abafadores e plugs, e por que a perda auditiva é permanente."
...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>NRR:</strong> índice de atenuação em decibéis — maior é melhor, mas só vale se a vedação estiver correta.</li>
    <li><strong>Passiva:</strong> mais barata e simples, bloqueia todo som, ideal para treino solo.</li>
    <li><strong>Eletrônica:</strong> deixa passar voz e comandos, corta só o estampido — melhor para aula, grupo e competição.</li>
    <li><strong>Concha x plug:</strong> concha é prática, plug é compacto e compatível com armas longas.</li>
    <li><strong>Ambiente ruidoso:</strong> use dupla proteção — plug por dentro, abafador por cima.</li>
  </ul>
</Callout>
...
<Faq items={[
  ...
  { q: "Mesmo atirando com um calibre pequeno, como .22, preciso de proteção auditiva?", a: "Sim. Todo disparo de arma de fogo produz um ruído de impacto muito acima do limite seguro para o ouvido, independentemente do calibre. A diferença de intensidade entre calibres não elimina o risco — só muda a magnitude dele." },
  { q: "A haste dos óculos de proteção atrapalha a vedação do abafador?", a: "Pode atrapalhar, sim — é uma das causas mais comuns de vedação ruim, principalmente com abafador tipo concha. Vale conferir se o encaixe continua firme com os óculos colocados e, se não vedar bem, considerar um plug intra-auricular, que não sofre esse conflito." },
  { q: "Em ambiente aberto (campo, área externa), ainda preciso de proteção auditiva?", a: "Sim. O som se dissipa mais em ambiente aberto do que num estande fechado, mas o estampido continua acima do limite seguro para quem está perto da arma. A diferença de ambiente muda a intensidade do risco, não a necessidade de proteção." },
  { q: "Plug de espuma descartável perde eficácia com o uso?", a: "Sim. Plugs descartáveis exigem cuidado com a inserção e precisam ser trocados com frequência — reaproveitar um plug amassado, sujo ou deformado reduz a vedação e, com ela, a atenuação real que ele entrega." },
