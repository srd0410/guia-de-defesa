...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>Tem validade:</strong> o CRAF vence e precisa ser renovado periodicamente, o prazo muda por decreto.</li>
    <li><strong>Como renovar:</strong> reconfirmar requisitos, reapresentar aptidão psicológica, pagar taxa e protocolar na Polícia Federal.</li>
    <li><strong>Se vencer:</strong> não perde a arma, mas fica em situação irregular, com possível repercussão penal.</li>
    <li><strong>CAC é diferente:</strong> envolve também habitualidade e acervo, hoje sob a Polícia Federal, não mais o Exército.</li>
    <li><strong>Regra de ouro:</strong> renovar com antecedência, nunca improvisar diante de um registro já vencido.</li>
  </ul>
</Callout>
...
Para quem é ou pretende ser CAC, portanto, "renovação" é um tema mais amplo do que só o CRAF de uma arma: envolve manter a condição de CAC, a habitualidade e o acervo regulares, agora sob a competência da Polícia Federal. O universo completo está nos guias de [como tirar o CAC](/como-tirar-cac/) e [quais armas o CAC pode ter](/quais-armas-cac-pode-ter/). E atenção a um ponto atual e específico: a PF prorrogou os CRAFs de CAC que venceriam em julho de 2026 e criou um calendário escalonado por mês de nascimento — veja as datas em [renovação de CRAF 2026](/renovacao-craf-2026/). No fim, a renovação do CAC é mais complexa que a do cidadão comum e mudou de órgão em 2025 — confirme tudo na Polícia Federal.
...
O terceiro erro é **agir por conta própria diante de um registro já vencido**, seja ignorando o problema, seja manuseando ou deslocando a arma como se tudo estivesse normal. Dada a possível repercussão penal da irregularidade, isso pode agravar a situação. A correção é buscar a via oficial de regularização junto à Polícia Federal e, pela seriedade do tema, considerar orientação jurídica. Os três erros — perder o prazo, subestimar as exigências e improvisar com registro vencido — são igualmente evitáveis com antecedência e método.

<Faq items={[
  { q: "O registro de arma tem validade ou é permanente?", a: "Tem validade. O registro não é permanente: o CRAF traz uma data de vencimento e precisa ser renovado periodicamente para a arma seguir regular. O prazo exato muda por decreto, então confirme a validade do seu caso no próprio CRAF e nos canais da Polícia Federal." },
  { q: "Por que preciso comprovar tudo de novo se já passei por isso para tirar o registro?", a: "Porque a lógica da renovação é de controle contínuo, não de burocracia repetida: o Estado reavalia periodicamente se você ainda cumpre os requisitos (idoneidade, aptidão), mantendo o registro como um retrato atual da sua situação, e não um documento que envelhece sem correspondência com a realidade." },
  { q: "Como renovar o registro de arma?", a: "Junto à Polícia Federal, antes do vencimento: reconfirmando requisitos (idoneidade, ocupação, residência), em geral reapresentando a aptidão psicológica por laudo atualizado, recolhendo a taxa quando exigida e protocolando pelo canal oficial. As exigências exatas dependem da norma vigente — confirme antes." },
  { q: "Preciso refazer o laudo psicológico para renovar?", a: "Em geral sim: a aptidão psicológica costuma precisar de laudo atualizado na renovação, conforme a regra vigente. Como essa exigência pode variar por decreto, confirme o que é exigido no momento da sua renovação diretamente na Polícia Federal antes de iniciar." },
  { q: "O que acontece se o registro de arma vencer?", a: "Você não perde a propriedade da arma, mas ela fica em situação irregular, com consequências administrativas e possível repercussão penal (como posse irregular), conforme o caso e a norma. Regularize pela via oficial na Polícia Federal e, dada a seriedade, considere orientação jurídica." },
  { q: "Posso usar a arma com o registro vencido?", a: "Não é o caminho seguro. Com o registro vencido, a arma está em situação irregular, e manusear, transportar ou portar nesse cenário pode agravar o problema. O correto é regularizar antes pela via oficial. Lembre ainda que, mesmo regular, o registro dá posse — não porte." },
  { q: "Por que tanta gente só percebe que o registro venceu quando já é tarde?", a: "Porque a renovação não gera o mesmo alarme de um vencimento de documento do dia a dia — não há uma cobrança automática visível. A defesa prática é anotar a data de validade do CRAF assim que ele sai e criar um lembrete com meses de antecedência, tratando a renovação como compromisso recorrente, não como surpresa." },
  { q: "A renovação do CAC é igual à do cidadão comum?", a: "Não. O CAC tem obrigações mais amplas (habitualidade, manutenção da condição de CAC e do acervo) e, desde 1º de julho de 2025, sob a competência da Polícia Federal, não mais do Exército. O cidadão comum sempre renovou na PF (SINARM). Veja a diferença entre os sistemas em SINARM x SIGMA." },
  { q: "Quanto custa renovar o registro de arma?", a: "Não há um valor único: soma a taxa da Polícia Federal (GRU), quando exigida, e os custos de eventuais laudos (como a aptidão psicológica). Taxas e exigências mudam por norma — confirme os valores vigentes na Polícia Federal antes de iniciar a renovação." },
]} />
...
Como os prazos e as exigências mudam por decreto, confirme sempre os números atuais na fonte oficial. Para o contexto completo, veja [como tirar o registro de arma](/como-tirar-registro-de-arma/), a diferença entre os sistemas em [SINARM x SIGMA](/sinarm-x-sigma/) e o panorama geral na [lei de armas no Brasil](/lei-de-armas-no-brasil/). Se o seu caso é especificamente o CRAF de CAC, veja o [guia completo da renovação de CRAF](/renovacao-de-craf-guia-completo/) e descubra o seu prazo exato com o [verificador de prazo do CRAF](/meu-craf-segue-o-calendario/). E, diante de um registro vencido, considere orientação jurídica antes de qualquer passo.
