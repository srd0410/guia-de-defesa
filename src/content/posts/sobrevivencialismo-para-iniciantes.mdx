...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>Horizonte real:</strong> setenta e duas horas a duas semanas, não anos — preparo modesto e barato.</li>
    <li><strong>Ordem de prioridade:</strong> água, comida, energia/luz e primeiros socorros, nessa sequência.</li>
    <li><strong>Preparo invisível:</strong> documentos digitalizados e reserva financeira em espécie.</li>
    <li><strong>Método:</strong> incremental, um plano de três meses, sem tentar resolver tudo de uma vez.</li>
    <li><strong>O que mais importa:</strong> um protocolo de família ensaiado, não o equipamento comprado.</li>
  </ul>
</Callout>
...
A linha entre preparo inteligente e paranoia está no que você assume como provável. Você se prepara para o que tem chance real de acontecer com a sua família, não para o cenário de filme que consome anos de planejamento e nunca chega. No Brasil, o provável tem nome: apagões de um a quatro dias, enchentes e alagamentos, falta temporária de água, eventos de segurança pública e emergências médicas sem socorro imediato. No fim das contas, se o seu preparo cobre bem essa lista, você já está à frente de quase todo mundo — sem precisar de nada que pareça coisa de *prepper* ("sobrevivencialista") de internet.
...
A regra que importa aqui: antes de comprar qualquer coisa, ajuste a régua. O objetivo é prontidão para o comum, e o comum é mais modesto — e mais frequente — do que o imaginário do apocalipse faz parecer.
...
A segunda é a reserva financeira, que é a forma mais universal de preparo que existe. Dinheiro em espécie importa de verdade, porque maquininha e Pix caem no apagão, e uma reserva líquida na conta dá capacidade de agir sem depender de crédito no pior momento. Vale dizer, antes de comprar equipamento tático, um envelope com dinheiro físico e uma pequena reserva de emergência fazem mais por você do que qualquer equipamento da moda.
...
Nenhum equipamento substitui um plano que a família conhece de cor. Defina poucas coisas e ensaie uma vez: um ponto de encontro fora de casa e fora do bairro, caso vocês sejam pegos separados; um contato central de fora da cidade para coordenar; duas rotas de saída do bairro mapeadas antes da necessidade; e quem faz o quê — quem pega as crianças, quem leva o kit. O passo a passo do [plano de comunicação familiar em emergências](/plano-de-comunicacao-familiar-em-emergencias/) organiza contatos, mensagens e alternativas sem internet. Portanto, um ensaio de meia hora com a família vale mais do que qualquer compra, porque é o que faz todo o resto funcionar na hora.
