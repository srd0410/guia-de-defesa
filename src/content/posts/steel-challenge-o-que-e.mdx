...
<Callout type="resumo" title="Resposta rápida">
  <ul>
    <li><strong>O que é:</strong> tiro de velocidade contra alvos de aço fixos, pontuado por tempo total.</li>
    <li><strong>Pontuação:</strong> cinco strings por stage, descarta-se a pior, soma-se o restante.</li>
    <li><strong>Ponto crítico:</strong> a placa de parada encerra o cronômetro e costuma ser o último alvo.</li>
    <li><strong>Divisões:</strong> por calibre (rimfire x centerfire) e por tipo de mira/configuração.</li>
    <li><strong>Para iniciante:</strong> divisões .22, regras simples e retorno imediato do aço.</li>
  </ul>
</Callout>
...
Para o iniciante, as divisões de calibre .22 são uma porta de entrada muito recomendada. O menor recuo, o menor custo de munição e a maior facilidade de controle permitem focar na técnica de velocidade sem a complicação do recuo forte. Muitos atiradores começam no Steel Challenge justamente com uma pistola ou carabina .22 antes de migrar para calibres maiores. Há uma divisão para cada perfil — e a escolha certa para começar costuma ser a mais leve.
...
<Faq items={[
  ...
  { q: "Uma tentativa ruim arruína o meu resultado no stage?", a: "Não sozinha. Cada stage é disparado em várias tentativas (strings, geralmente cinco), e a pior delas é descartada antes de somar o resultado final. O sistema foi pensado para premiar consistência ao longo das tentativas, não para punir um único deslize isolado." },
  ...
  { q: "O Steel Challenge tem alguma ligação com o tiro prático (USPSA)?", a: "Sim. A entidade que organiza o Steel Challenge internacionalmente, a SCSA, é ligada à USPSA, a federação norte-americana de tiro prático. Por isso a modalidade costuma ser praticada por gente que também atira tiro prático — as duas se alimentam, mesmo sendo tecnicamente distintas." },
